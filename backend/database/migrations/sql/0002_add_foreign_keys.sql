...
ALTER TABLE "team_location" ADD FOREIGN KEY ("team_id") REFERENCES "teams" ("id");
ALTER TABLE "team_location" ADD FOREIGN KEY ("location_id") REFERENCES "locations" ("id");

ALTER TABLE "games" ADD FOREIGN KEY ("season_id") REFERENCES "seasons" ("id");
ALTER TABLE "games" ADD FOREIGN KEY ("opponent_id") REFERENCES "teams" ("id");
